    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/track-shipment" class="group">
          ...
          <Link href="/transportation-management" class="group">
          ...
          <Link href="/inventory-warehouse-management" class="group">
          ...
          <Link href="/manufacturing-management" class="group">
          ...
          <Link href="/delivery-management" class="group">
      ...
      <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="text-center">
            ...
            <h4 class="text-lg font-semibold text-gray-900">Redis Cache</h4>
