...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $order1 = FreightOrder::firstOrCreate(
        ...
        $order2 = FreightOrder::firstOrCreate(
        ...
        $order3 = FreightOrder::firstOrCreate(
        ...
        \App\Models\ShipmentEvent::firstOrCreate(
            [
